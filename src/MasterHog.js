...
export default class MasterHog extends Component {
  ...
  createBabies = (offSpringArr) => {
    return offSpringArr.map((baby) => {
      return <BabyHog name={baby.name} id={baby.id} hobby={baby.hobby} eyeColor={this.state.eyeColor} />
    })
  }
